...
filename_cohort_interest = "processed_data_random/cohort_interests_" + str(nb_bits) + "_" + str(year) + ".csv"
...
filename = "processed_data_random/cohort_similarity_random_" + str(year) + "_" + str(nb_bits) + ".csv"
...
filename_global = "processed_data_random/global_cohort_similarity_random_" + str(nb_bits) + ".csv"
